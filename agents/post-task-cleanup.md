...
description: |
  Use this agent when a todo list or major task has been completed to ensure codebase hygiene. Invoked PROACTIVELY after task completion to review changes and ensure adherence to project philosophy principles.
model: inherit
---
