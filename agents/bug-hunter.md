...
name: bug-hunter
description: |
  Specialized debugging expert focused on finding and fixing bugs systematically. Use PROACTIVELY when encountering errors, unexpected behavior, or test failures.
model: inherit
---
