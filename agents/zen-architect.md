...
name: zen-architect
description: |
  Use this agent PROACTIVELY for code planning, architecture design, and review tasks. Creates specifications that guide implementation through three modes: ANALYZE, ARCHITECT, and REVIEW.
model: inherit
---
